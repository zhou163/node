...
function default_1(styleApi) {
    var and = styleApi.and, hasDefaultMember = styleApi.hasDefaultMember, hasNamedMembers = styleApi.hasNamedMembers, hasNamespaceMember = styleApi.hasNamespaceMember, hasNoMember = styleApi.hasNoMember, hasOnlyDefaultMember = styleApi.hasOnlyDefaultMember, hasOnlyNamedMembers = styleApi.hasOnlyNamedMembers, hasOnlyNamespaceMember = styleApi.hasOnlyNamespaceMember, isAbsoluteModule = styleApi.isAbsoluteModule, isRelativeModule = styleApi.isRelativeModule, member = styleApi.member, name = styleApi.name, not = styleApi.not, startsWithAlphanumeric = styleApi.startsWithAlphanumeric, startsWithLowerCase = styleApi.startsWithLowerCase, startsWithUpperCase = styleApi.startsWithUpperCase, unicode = styleApi.unicode;
    return [
        // import "foo"
